...
var hue = function () { 
    ...
    var shortFlashType = 'select',
        ...
        /**
         * Simply log the response by default.
         * @param {Object} error: needle HTTP error
         * @param {Object} response: needle HTTP response
         * @param {Object} body: needle HTTP response body
         */
        apiSuccess = function(error, response, body) {
        ...
        putJSON = function(url, callback, data) {
            needle.put(url, JSON.stringify(data), callback);
            return data;
        },
        ...
        get = function(destination, success) {
            ...
            needle.get(destination, function(error, response, body) {
                stateData = body;
            });
    ...
    return {
        ...
        /** Expose colors module directly to consumers */
        colors: colors
    };
}();
