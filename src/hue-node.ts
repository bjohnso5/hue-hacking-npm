...
export class Hue extends HueBridge {
  ...
  public async flash(lampIndex: number): Promise<HueBridgeStateChangeResponse> {
    return this.put(lampIndex, shortFlashState).then(
  ...
  public async flashAll(): Promise<HueBridgeGroupActionResponse> {
    return this.putGroupAction(0, shortFlashState).then(
  ...
  public async longFlash(
    ...
    return this.put(lampIndex, longFlashState).then(
      r => new HueBridgeStateChangeResponse(r.data)
    );
  }
  ...
  public async longFlashAll(): Promise<HueBridgeGroupActionResponse> {
    return this.putGroupAction(0, longFlashState).then(
      r => new HueBridgeGroupActionResponse(r.data)
    );
  }
