 ...
 */
function successfulPut(responsePayload: unknown): unknown {
 ...
 * @param responsePayload Response body
 */
function successfulGet(responsePayload: unknown): unknown {
...
test.serial('setBrightness', async (t) => {
  const responsePayload: Record<string, unknown>[] = [
    { success: { '/lights/1/state/bri': 231 } },
  ];
...
test.serial('setGroupBrightness', async (t) => {
  ...
  t.deepEqual(
    setBriResponse,
    new HueBridgeGroupActionResponse(
